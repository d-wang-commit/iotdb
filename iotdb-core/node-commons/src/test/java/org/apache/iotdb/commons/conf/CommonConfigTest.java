...
public class CommonConfigTest {
  ...
  public void testHandleUnrecoverableErrorBuildsStatusReason() {
    ...
    CommonConfig.NodeStatusSnapshot originalSnapshot = config.getNodeStatusSnapshot();
    try {
      ...
      config.compareAndSetNodeStatus(config.getNodeStatusSnapshot(), originalSnapshot);
    }
  }
